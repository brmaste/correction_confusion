...
# 4/24/2023 update
Including YSI temperature sensor bias equation from Joel Atwood at the Colorado Snow Survey, presented at the 2023 Western Snow Conference. Associated website [here.](https://www.nrcs.usda.gov/wps/portal/wcc/home/snowClimateMonitoring/temperature/temperatureBiasCorrection/)

```{r conditional_block, echo=FALSE}
print("610558.226380138*(((T_(bias-c)+65.929))/194.45)^9- 2056177.65461394*(((T_(bias-c)+65.929))/194.45)^8+ 2937046.42906361*(((T_(bias-c)+65.929))/194.45)^7-2319657.12916417*(((T_(bias-c)+65.929))/194.45)^6+1111854.33825836*(((T_(bias-c)+65.929))/194.45)^5-337069.883250001*(((T_(bias-c)+65.929))/194.45)^4+66105.7015922199*(((T_(bias-c)+65.929))/194.45)^3- 8386.78320604513*(((T_(bias-c)+65.929))/194.45)^2+ 824.818021779729*(((T_(bias-c)+65.929))/194.45)-86.7321006757439= T_c")
```
...
```{r all temperatures all corrections}
